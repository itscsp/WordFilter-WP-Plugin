...
class  WordFilter {
    ...
    function replacementFieldHTML(){?>
        ...
        <p class="description">Leave blank to simply remove the filteredd words.</p>
    <?php }
    ...
    function ourMenu() {
        ...
        $mainPageHook = add_submenu_page('ourwordfilter', 'Words To Filter', 'Word List', 'manage_options', 'ourwordfilter', array($this, 'wordFilterPage'));
